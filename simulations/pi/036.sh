...
echo
echo "Please log into rasp-18 and run ./simulations/pi/018.sh up to this point"
echo "The minimal set of public keys must then be exchanged with rasp-018:"
echo
echo "  scp \"$tmp/L.pub.pem\" \"rasp-018:$tmp\""
echo
...
echo "  TCDICN_PORT=33336 TCDICN_DPORT=33333 TCDICN_ID=I TCDICN_KEYFILE=\"$tmp/I.pem\" TCDICN_GROUPS=\"2:$tmp/K.pub.pem\" PYTHONPATH=. python3 applications/drone.py"
...
echo "  TCDICN_PORT=33338 TCDICN_DPORT=33333 TCDICN_ID=K TCDICN_KEYFILE=\"$tmp/K.pem\" TCDICN_GROUPS=\"2:$tmp/G.pub.pem,$tmp/I.pub.pem,$tmp/L.pub.pem\" KNOWN_DRONES=\"B,G,I\" PYTHONPATH=. python3 applications/inspector.py"
echo "  TCDICN_PORT=33339 TCDICN_DPORT=33333 TCDICN_ID=L TCDICN_KEYFILE=\"$tmp/L.pem\" TCDICN_GROUPS=\"1:$tmp/F.pub.pem,$tmp/J.pub.pem 2:$tmp/F.pub.pem,$tmp/K.pub.pem\" KNOWN_DRONES=\"A,B,C,G,H,I\" PYTHONPATH=. python3 applications/controller.py"
